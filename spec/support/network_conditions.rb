module NetworkCondition
  ...
  def go_online
    page.driver.browser.devtools(target_type: 'service_worker').network.emulate_network_conditions(**ONLINE_PARAMS)
    page.driver.browser.devtools.network.emulate_network_conditions(**ONLINE_PARAMS)
  end

  def go_offline
    page.driver.browser.devtools(target_type: 'service_worker').network.enable
    page.driver.browser.devtools(target_type: 'service_worker').network.emulate_network_conditions(**OFFLINE_PARAMS)
